...
The quantitative time series of comprehensively cataloging the biota encountered at each sampling station within these surveys began in 1982 with the adoption of standardized trawling protocols [@lauth2019], but trawl observations were made as early as 1955 [@zimmerman2009].
...
Age-length-keys (ALKs) generated from the age/length observations within a survey are then applied to estimated abundance-at-length to provide an estimate of abundance-at-age.
...
The stocks selected for this analysis *are shown in Table \@ref(tab:species)), and* were selected because all are assessed by AFSC with statistical catch-at-age models and have corresponding expanded age and/or length composition estimates from the respective bottom trawl surveys. 
...
The average length and age sample sizes from the most recent three survey years for the species selected by survey are shown in Table \@ref(tab:species_samples)). 
